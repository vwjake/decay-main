...
// GetInvolved lists the ways to plug into DECAY — the admin-managed form
// links (surveys and the like) plus a couple of standing calls to action.
func GetInvolved(forms []db.ExternalForm) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Layout("Get Involved · DECAY").Render(templ.WithChildren(ctx, templ_7745c5c3_Var2), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
